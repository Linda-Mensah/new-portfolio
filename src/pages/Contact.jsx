const Contact = () => {
  return (
    <section className="contact-section   max-w-[800px] bg-gray-100 text-center rounded-xl shadow-md">
      <h2 className="contact-title text-2xl font-semibold text-black">
        Now you know about me. Let's get to know you too
      </h2>
      <p className="contact-subtitle text-teal-700 text-base">
        Got a project in mind or just want to connect? I'm all ears.
      </p>

      <form className="contact-form flex flex-col gap-4">
        <div className="input-row flex flex-wrap gap-4">
          <input
            type="text"
            placeholder="Your Name"
            required
            className="input flex-1 border border-gray-300 rounded-md text-base px-3 py-2"
          />
          <input
            type="email"
      ...
      <div className="contact-bottom bg-cyan-50 border-t border-gray-300 rounded-md flex flex-wrap justify-between items-start">
        <div className="contact-bottom-left flex-1 min-w-[300px]">
        ...
        <div className="contact-bottom-right flex-1 min-w-[300px]">
